...
async function singleMovie() {
    ...
    <div class="movie-details">
        <div class="details-header">
            ...
            <div class="dh-rs">
                <i class="fa-solid fa-rectangle-list fa-lg" style="color: #0a0a0b;" onClick=addTofavorites('${id}') style="cursor: pointer;"></i>
            </div>
        </div>
        ...
        <div class="fav-item">
            ...
            <div class="fav-details">
                <div class="fav-details-box">
                    ...
                    <div>
                        <i class="fa-solid fa-rectangle-list fa-lg" style="color: #0a0a0b;" style="cursor:pointer;" onClick=addTofavorites('${id}')></i>
                    </div>
                </div>
            </div>
        </div>
